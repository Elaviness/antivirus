...
namespace Scan
{
    abstract class DirectoryMonitor
    {
    //    //Создать класс DirectoryMonitor, позволяющий хранить все директории,
    //    //которые просматриваются в данный момент.Для каждой директории должна
    //    //быть возможность указать дополнительные параметры. На данном уровне определяются только абстракции.
